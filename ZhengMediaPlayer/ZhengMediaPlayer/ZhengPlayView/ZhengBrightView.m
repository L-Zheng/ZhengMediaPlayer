...
#define ZhengBrightViewH 20
#define ZhengBrightViewW 130
...
@implementation ZhengBrightView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        self.width = ZhengBrightViewW;
        self.height = ZhengBrightViewH;
...
- (void)bgViewTapGesture:(UITapGestureRecognizer *)tapGesture{
    ...
    if ([_delegate respondsToSelector:@selector(zhengBrightView:bgViewTapGesture:brightValue:)]) {
        [_delegate zhengBrightView:self bgViewTapGesture:tapGesture brightValue:progressValue];
    }
}
...
- (void)indicatorButtonPanGesture:(UIPanGestureRecognizer *)panGesture{
    ...
    if ([_delegate respondsToSelector:@selector(zhengBrightView:indicatorButtonPanGesture:brightValue:)]) {
        [_delegate zhengBrightView:self indicatorButtonPanGesture:panGesture brightValue:progressValue];
    }
}
